...
import { Moon, Sun, Globe, Github, ExternalLink, Mail, Server, Zap } from 'lucide-react';
...
const App = () => {
  ...
  const content = {
    en: {
      ...
      subtitle: "Building reliable infrastructure and automating deployment pipelines",
      about: "Passionate about infrastructure automation, cloud technologies, and continuous deployment practices.",
      ...
      companies: [
        {
          ...
          description: "Supporting CI/CD pipeline development and container orchestration with Docker and Kubernetes, implementing monitoring solutions and maintaining cloud infrastructure",
          years: "2024 - Present",
          role: "Junior DevOps Engineer",
          logo: "https://via.placeholder.com/80x80/F97316/FFFFFF?text=CT"
        },
        {
          name: "StartupBase",
          description: "Assisting with AWS infrastructure setup and monitoring system implementation, learning cloud best practices and automation tools",
          years: "2023 - 2024",
          role: "DevOps Intern",
          logo: "https://via.placeholder.com/80x80/EA580C/FFFFFF?text=SB"
        },
        {
          name: "TechLab Academy",
          description: "Learning system administration and basic automation scripting with Python and Bash, building foundation in Linux systems",
          years: "2022 - 2023",
          role: "System Admin Trainee",
          logo: "https://via.placeholder.com/80x80/FB923C/FFFFFF?text=TL"
        }
      ],
      petProjects: [
        {
          name: "Docker Monitoring Stack",
          description: "Complete monitoring solution using Prometheus, Grafana, and Docker Compose for container metrics visualization and alerting with custom dashboards",
          tech: ["Docker", "Prometheus", "Grafana", "Docker Compose", "AlertManager"],
          link: "https://github.com/inchange-dev/docker-monitoring",
          demo: "https://monitoring-demo.inchange.dev",
          logo: "https://via.placeholder.com/100x100/F97316/FFFFFF?text=DM"
        },
        {
          name: "CI/CD Pipeline Automation",
          description: "Automated deployment pipeline using GitHub Actions for web applications with testing, security scanning, and multi-environment deployment stages",
          ...
          logo: "https://via.placeholder.com/100x100/EA580C/FFFFFF?text=CI"
        },
        {
          name: "Infrastructure as Code",
          description: "AWS infrastructure provisioning using Terraform with automated scaling, backup solutions, and comprehensive logging and monitoring setup",
          ...
          logo: "https://via.placeholder.com/100x100/FB923C/FFFFFF?text=IA"
        }
      ]
    },
    ru: {
      ...
      subtitle: "Создаю надёжную инфраструктуру и автоматизирую пайплайны развёртывания",
      about: "Увлечён автоматизацией инфраструктуры, облачными технологиями и практиками непрерывного развёртывания.",
      ...
      companies: [
        {
          name: "CloudTech Solutions",
          description: "Поддержка разработки CI/CD пайплайнов и оркестрации контейнеров с Docker и Kubernetes, внедрение решений мониторинга и поддержка облачной инфраструктуры",
        ...
        {
          name: "StartupBase",
          description: "Помощь в настройке AWS инфраструктуры и внедрении систем мониторинга, изучение лучших практик облачных технологий и инструментов автоматизации",
          years: "2023 - 2024",
          role: "DevOps Стажёр",
          logo: "https://via.placeholder.com/80x80/EA580C/FFFFFF?text=SB"
        },
        {
          name: "TechLab Academy",
          description: "Изучение системного администрирования и базовой автоматизации на Python и Bash, создание фундамента в Linux системах",
          years: "2022 - 2023",
      ...
      petProjects: [
        {
          name: "Docker Monitoring Stack",
          description: "Полное решение для мониторинга с использованием Prometheus, Grafana и Docker Compose для визуализации метрик контейнеров и оповещений с кастомными дашбордами",
          tech: ["Docker", "Prometheus", "Grafana", "Docker Compose", "AlertManager"],
          link: "https://github.com/inchange-dev/docker-monitoring",
          demo: "https://monitoring-demo.inchange.dev",
          logo: "https://via.placeholder.com/100x100/F97316/FFFFFF?text=DM"
        },
        {
          ...
          description: "Автоматизированный пайплайн развёртывания с использованием GitHub Actions для веб-приложений с тестированием, сканированием безопасности и развёртыванием в несколько сред",
          tech: ["GitHub Actions", "Docker", "AWS", "Terraform", "Jest"],
          link: "https://github.com/inchange-dev/cicd-pipeline",
          demo: "https://pipeline-demo.inchange.dev",
          logo: "https://via.placeholder.com/100x100/EA580C/FFFFFF?text=CI"
        },
        {
          ...
          description: "Провизионирование AWS инфраструктуры с использованием Terraform с автоматическим масштабированием, решениями резервного копирования и комплексной настройкой логирования и мониторинга",
          tech: ["Terraform", "AWS", "CloudWatch", "S3", "Lambda"],
          link: "https://github.com/inchange-dev/terraform-aws",
          demo: "https://infrastructure-demo.inchange.dev",
          logo: "https://via.placeholder.com/100x100/FB923C/FFFFFF?text=IA"
  ...
  return (
    <div className={`min-h-screen transition-all duration-700 ${
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className={`neural-network-orange ${isDark ? 'opacity-30' : 'opacity-15'}`} />
          ...
          <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
            ...
            >
              <div className="flex justify-center mb-6">
                ...
                >
                  <Server className="w-16 h-16 text-orange-500 mx-auto" />
                </motion.div>
              </div>
        ...
        >
          <motion.div 
            className={`w-6 h-12 border-2 rounded-full flex justify-center cursor-pointer ${
              isDark ? 'border-gray-600 hover:border-orange-400' : 'border-gray-400 hover:border-orange-500'
            } transition-colors`}
            whileHover={{ scale: 1.1 }}
            onClick={() => scrollToSection('experience')}
          >
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid gap-8">
            {t.companies.map((company, index) => (
              ...
              >
                <div className={`p-6 sm:p-8 backdrop-blur-md rounded-3xl border transition-all duration-500 hover:shadow-2xl ${
                  isDark 
                  ...
                  <div className="flex flex-col md:flex-row gap-6">
                    ...
                    <div className="flex-grow">
                      <div className="flex flex-col md:flex-row justify-between items-start mb-4">
                        <div>
                          <h3 className={`text-xl sm:text-2xl font-bold mb-2 group-hover:text-orange-400 transition-colors ${
                            isDark ? 'text-gray-100' : 'text-gray-900'
                          }`}>
                            {company.name}
                          </h3>
                          <p className="text-orange-400 font-semibold mb-3">{company.role}</p>
                          <p className={`text-sm sm:text-base ${isDark ? 'text-gray-300' : 'text-gray-600'}`}>
                            {company.description}
                          </p>
                        </div>
                        <div className={`text-xs sm:text-sm px-3 sm:px-4 py-1 sm:py-2 rounded-full mt-4 md:mt-0 ${
                          isDark 
      ...
      {/* Enhanced Footer */}
      <footer className={`py-12 px-6 border-t ${isDark ? 'border-gray-700' : 'border-gray-200'}`}>
        <div className="max-w-6xl mx-auto">
