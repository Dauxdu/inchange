  ...
  return (
    <div className="relative">
      ...
      <div className={`absolute left-8 top-0 bottom-0 w-0.5 ${
        isDark ? 'bg-gradient-to-b from-orange-500 to-red-600' : 'bg-gradient-to-b from-orange-600 to-red-700'
      }`} />
            ...
            <div className="flex flex-col md:flex-row justify-between items-start mb-4">
              <div className="flex-grow">
                ...
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-orange-400 font-semibold">{company.role}</span>
                </div>
              ...
              <div className={`flex items-center gap-2 px-3 py-1 rounded-full text-xs mt-4 md:mt-0 ${
                isDark 
            ...
            {index === 0 && (
              <motion.div
                ...
                className={`h-1 rounded-full ${
                  isDark ? 'bg-gradient-to-r from-orange-500 to-red-600' : 'bg-gradient-to-r from-orange-600 to-red-700'
                }`}
              />
            )}
          </motion.div>
